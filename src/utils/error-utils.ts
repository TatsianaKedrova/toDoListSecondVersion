...
export const handleServerNetworkError = (error: any,dispatch:Dispatch<AppSetStatusType | SetAppErrorType>) => {
    dispatch(setAppStatusAC(error.message ? error.message : "Some error occurred!"));
    dispatch(setAppStatusAC("failed"))
};
